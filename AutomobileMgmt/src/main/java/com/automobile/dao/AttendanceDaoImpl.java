...
public class AttendanceDaoImpl implements AttendanceDao {
	...
	public List<Employee> searchEmployee(Employee employee) {
		...
		List<Employee> employeeList = jdbcTemplate.query(sql, new Object[] { employee.getEmployeeId(), employee.getEmployeeName() },
				new RowMapper<Employee>() {
					...
					public Employee mapRow(ResultSet rs, int rowNum) throws SQLException {
						...
						employee.setDepartment(rs.getString("designation"));
						return employee;
					}
				});
		return employeeList;
	...
	public List<Employee> searchEmployeeByName(Employee employee) {
		...
		List<Employee> employeeList = jdbcTemplate.query(sql, new Object[] { employee.getEmployeeName() },
				new RowMapper<Employee>() {
	...
	public List<Employee> searchEmployeeById(Employee employee) {
		...
		List<Employee> employeeList = jdbcTemplate.query(sql, new Object[] { employee.getEmployeeId() },
				new RowMapper<Employee>() {
